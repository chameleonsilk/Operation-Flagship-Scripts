...
local rad_option_0a = "Recieve Bullseye Call (NA)"
local rad_option_1a = "Recieve BRA Call (NA)"
local rad_option_0b = "Change Difficulty Setting"
local rad_option_1b = "Change Task Spawn Distance"
local rad_option_2b = "Respawn/Launch AWACS"
local rad_option_3b = "Respawn/Launch Tanker"
local rad_option_0c = "Create Fighter Intercept"
local rad_option_1c = "Create Bomber Intercept"
local rad_option_2c = "Add Bomber Escort"
local rad_option_3c = "Create Strike Mission (NA)"
local rad_option_4c = "Create Escort Mission (NA)"
local rad_option_5c = "Create SEAD Mission (NA)"
local rad_option_6c = "Create CAS Mission (NA)"
...
CAS_Planes = {
	...
	GameSet = missionCommands.addSubMenu("Simulation Settings",nil)
...
if Radio_Table[unitName] == nil then
	...
	--missionCommands.addCommandForGroup(Rad_GroupID, rad_option_0a, Calls, Nothing, nil)
